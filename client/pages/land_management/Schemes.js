  ...
  return (
    <div  style={{padding:"2rem"}}>
      ...
      <Container>
        ...
        <p>Beautification/Slum Clearance</p>

        <Header>1. Banks of River Jehlum</Header>
        <p>
          For centuries river Jehlum has been flowing through the city of
          Srinagar, lending it a unique character both for locals as well as
          visitors. With the population explosion the banks of this majestic
          river have become an eyesore for the city.
        </p>

        <p>
          SDA embarks on an ambitious program for beautification of both banks
          of this historic river by way of removal of slums which have emerged
          on the river banks.
        </p>
        ...
        <p>
          ...
          demolished in two demolition operations and 226 families have been
          identified for rehabilitation in a joint survey conducted by I&FC
          Deptt, Revenue Department, SDA and SMC before demolition. . The
          identified boatmen have been provided plot of 700 sft in Boatmen
          colony, EWS Colony Bemina and at Nooorbagh.
        </p>

        <p>
          14 affected families living in Babademb water body have also been
          proved with plots in EWS Colony Bemina besides 20 families living in
          boats/sheds in Zainakadal have also been provided with plots whose
          boats/ sheds were damaged due to construction of new Zainakdal Bridge
          on the basis of list furnished by the R&B Deparmtnet.
        </p>

        <p>
          Each affected family will be provided an amount of Rs. 45,000 for
          raising a dwelling unit The detailed survey of the remaining families
          living in doongas and sheds on the banks of river Jehlum is being
          conducted and all the families will be shifted in phases for which a
          comprehensive scheme has been prepared and submitted to State/Central
